...
// const char* classNames[] = {"person","bicycle","car","motorbike","aeroplane","bus","train","truck","boat","traffic light","fire hydrant",
...
// "keyboard","cell phone","microwave","oven","toaster","sink","refrigerator","book","clock","vase","scissors","teddy bear","hair drier",
// "toothbrush"};
...
int main(int argc, char** argv)
{
    ...
    {
        writer.open(parser.get<String>("out"), codec, 30, Size((int)cap.get(CAP_PROP_FRAME_WIDTH),(int)cap.get(CAP_PROP_FRAME_HEIGHT)), 1);
    }
